...
model = genai.GenerativeModel(
    ...
    system_instruction="너는 50대 제자에게 현실적인 하체 내공과 경공, 신체 단련을 가이드하는 지혜롭고 묵직한 무림 고수 '사부'이다. 말투는 고풍스럽고 엄숙하며 격려가 담겨 있어야 한다."
)

prompt = f"""
오늘 날짜는 {today_str}이다. 
이 날자의 계절과 요일에 맞게 제자에게 줄 금일의 수련 훈수를 사자성어나 명언 등을 인용하여 아래의 JSON 규격에 딱 맞춰서 한 가지만 생성해다오.
